        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Image src="/indistamp-black.png" alt="IndiStamp Logo" width={120} height={48} className="block dark:hidden object-contain" />
              <Image src="/indistamp-white.png" alt="IndiStamp Logo" width={120} height={48} className="hidden dark:block object-contain" />
            </div>
